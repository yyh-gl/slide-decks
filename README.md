...
- lang: '{kotlin,go,rust,python,java,javascript,typescript}'
  run: 'silicon -l "{{lang}}" --theme "Visual Studio Dark+" --no-window-controls --pad-horiz 0 --pad-vert 0 -o "{{output}}"'
- lang: '{ebnf}'
  run: 'silicon -l "go" --theme "Visual Studio Dark+" --no-window-controls --pad-horiz 0 --pad-vert 0 -o "{{output}}"'
  ext: png
- lang: '*'
