...
(function testHTML() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("textlint-plugin-html")); })];
                case 1:
                    htmlPlugin = (_a.sent()).default;
                    tester.run("textlint-rule-sentence-length:plugin", {
                        plugins: [
                            {
                                pluginId: "html",
                                plugin: htmlPlugin
                        ...
                        rules: [
                            {
                                ...
                                rule: sentence_length_1.default,
                                options: {
                                    max: 15
                                }
                            }
...
//# sourceMappingURL=sentence-length-html-test.js.map