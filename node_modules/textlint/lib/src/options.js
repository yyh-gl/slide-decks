...
const concatFormatterList = (formatterList) => {
...
exports.options = (0, optionator_1.default)({
    ...
    options: [
        ...
        },
        {
            ...
            default: node_path_1.default.resolve(process.cwd(), ".textlintignore"),
        ...
        },
        {
            ...
            type: "path::String",
            default: node_path_1.default.resolve(process.cwd(), ".textlintcache"),
