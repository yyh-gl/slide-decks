...
class TextlintRuleContextImpl {
    constructor(args) {
        ...
        this.report = (node, ruleError, _shouldNotUsed) => {
            (0, invariant_1.invariant)(!(node instanceof TextlintRuleErrorImpl_1.TextlintRuleErrorImpl), "1st argument should be node. Usage: `report(node, ruleError);`");
            (0, invariant_1.invariant)(_shouldNotUsed === undefined, "3rd argument should not be used. Usage: `report(node, ruleError);`");
