...
const TextlintRulePaddingLocator_1 = require("../context/TextlintRulePaddingLocator");
...
`);
    ...
    if (padding.padding !== undefined) {
        (0, invariant_1.invariant)((0, TextlintRulePaddingLocator_1.isTextlintRuleErrorPaddingLocation)(padding.padding), "reported { padding } is invalid format.");
    }
};
/**
...
const resolveFixCommandLocation = ({ node, ruleError }) => {
    ...
    (0, invariant_1.invariant)(typeof ruleError.fix === "object", "fix should be FixCommand object");
