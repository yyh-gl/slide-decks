...
const PreferTypes = exports.PreferTypes = {
  DESUMASU: "ですます",
  DEARU: "である"
};
...
module.exports = function noMixedDearuDesumasu(context, options = defaultOptions) {
  ...
  const ignoreManager = new _textlintRuleHelper.IgnoreNodeManager();
