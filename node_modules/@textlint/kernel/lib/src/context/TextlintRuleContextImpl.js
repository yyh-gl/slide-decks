...
const TextlintRuleContextFixCommandGeneratorImpl_js_1 = require("./TextlintRuleContextFixCommandGeneratorImpl.js");
const TextlintRuleSeverityLevelKeys_js_1 = require("./TextlintRuleSeverityLevelKeys.js");
const TextlintRuleErrorImpl_js_1 = require("./TextlintRuleErrorImpl.js");
...
const ruleFixer = new TextlintRuleContextFixCommandGeneratorImpl_js_1.TextlintRuleContextFixCommandGeneratorImpl();
class TextlintRuleContextImpl {
    constructor(args) {
        ...
        this.report = (node, ruleError, _shouldNotUsed) => {
            (0, invariant_js_1.invariant)(!(node instanceof TextlintRuleErrorImpl_js_1.TextlintRuleErrorImpl), "1st argument should be node. Usage: `report(node, ruleError);`");
            (0, invariant_js_1.invariant)(_shouldNotUsed === undefined, "3rd argument should not be used. Usage: `report(node, ruleError);`");
            if (ruleError instanceof TextlintRuleErrorImpl_js_1.TextlintRuleErrorImpl) {
                ...
                const level = ruleReportedObject.severity || TextlintRuleSeverityLevelKeys_js_1.TextlintRuleSeverityLevelKeys.error;
        ...
        this.locator = (0, TextlintRulePaddingLocator_js_1.createPaddingLocator)();
     ...
     */
    get RuleError() {
        return TextlintRuleErrorImpl_js_1.TextlintRuleErrorImpl;
    }
    /**
