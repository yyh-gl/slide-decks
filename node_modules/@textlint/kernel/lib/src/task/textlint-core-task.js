...
const TextlintRuleErrorImpl_js_1 = require("../context/TextlintRuleErrorImpl.js");
const promise_event_emitter_js_1 = require("./promise-event-emitter.js");
const source_location_js_1 = require("../core/source-location.js");
const timing_js_1 = __importDefault(require("../util/timing.js"));
const invariant_js_1 = require("../util/invariant.js");
const MessageType_js_1 = __importDefault(require("../shared/type/MessageType.js"));
const utils_1 = require("@textlint/utils");
const TextlintRuleContextImpl_js_1 = require("../context/TextlintRuleContextImpl.js");
...
class RuleTypeEmitter extends promise_event_emitter_js_1.PromiseEventEmitter {
}
/**
 ...
 */
class TextLintCoreTask extends promise_event_emitter_js_1.EventEmitter {
    static get events() {
        return {
            // receive start event
            start: "start",
    ...
    createReporter(sourceCode) {
        ...
        const reportFunction = (reportArgs) => {
            ...
            const { loc, range } = (0, source_location_js_1.resolveLocation)({
                source: sourceCode,
                ruleId,
                node,
                ruleError
            });
            const { fix } = (0, source_location_js_1.resolveFixCommandLocation)({
                node,
                ruleError
            });
    ...
    tryToAddListenRule(ruleCreator, ruleContext, ruleOptions) {
        const ruleObject = ruleContext instanceof TextlintRuleContextImpl_js_1.TextlintRuleContextImpl
        ...
        types.forEach((nodeType) => {
            this.ruleTypeEmitter.on(nodeType, timing_js_1.default.enabled ? timing_js_1.default.time(ruleContext.id, ruleObject[nodeType]) : ruleObject[nodeType]);
        });
    }
}
