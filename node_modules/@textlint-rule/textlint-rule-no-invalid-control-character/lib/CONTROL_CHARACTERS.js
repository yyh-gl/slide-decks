...
exports.INVALID_CONTROL_CHARACTERS = exports.CONTROL_CHARACTERS = void 0;
const CONTROL_CHARACTERS = exports.CONTROL_CHARACTERS = [{
  code: "\u0001",
...
// except
const INVALID_CONTROL_CHARACTERS = exports.INVALID_CONTROL_CHARACTERS = CONTROL_CHARACTERS.filter(CONTROL_CHARACTER => {
  const code = CONTROL_CHARACTER.code;
  return code !== "\r" && code !== "\n" && code !== "\t";
});
//# sourceMappingURL=CONTROL_CHARACTERS.js.map